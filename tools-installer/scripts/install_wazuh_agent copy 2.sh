...
WAZUH_VERSION="4.7.3"
W_PASS="admin"  # Password para el enrolamiento
...
# Generar Playbook con tu lógica de limpieza e INCLUYENDO ENROLAMIENTO
...
- name: "Instalación Limpia de Wazuh Agent"
  ...
  tasks:
    ...
    - name: "Realizar Enrolamiento Activo con el Manager"
      # Este paso asegura que el agente obtenga sus llaves (client.keys)
      shell: |
