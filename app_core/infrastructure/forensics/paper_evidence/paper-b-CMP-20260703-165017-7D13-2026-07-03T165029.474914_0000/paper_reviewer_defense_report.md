...
- Report ID: `paper-b-CMP-20260703-165017-7D13-2026-07-03T165029.474914_0000`
- Level requested: `B`
- Generated at: `2026-07-03T20:50:08.300648+00:00`
- Source campaign: `CMP-20260703-165017-7D13`
- Requested repetitions: `6`
- Completed / partial / failed: `0` / `6` / `0`
- Higher-level comparison status: `Comparable With Degradation`
- Nested Level A completed reports: `6`
...
- Compared executions: `EXEC-0001, EXEC-0002, EXEC-0003, EXEC-0004, EXEC-0005, EXEC-0006`

### Operational latency and acquisition

- Alert -> memory start mean/std: `-609.224667` / `9.978754`
- Alert -> case sealed mean/std: `414.743333` / `57.236009`
...
- Nested comparison statuses: `Comparable With Degradation, Not Comparable, Comparable With Degradation, Not Comparable, Comparable With Degradation, Comparable With Degradation`
...
- warning: Critical evidence gate failed; this case is diagnostic/audit only and is not scientifically complete.
- warning: Heavy generated case artifacts were cleaned after nested Level A reporting so the next Level B repetition could create a fresh case without accumulating heavy storage.
- blocker: missing_critical_evidence=pcap_packet_level_modbus_evidence_present, ot_export_present_in_manifest
- blocker: missing_critical_evidence=pcap_packet_level_modbus_evidence_present, ot_export_present_in_manifest
- blocker: missing_critical_evidence=pcap_packet_level_modbus_evidence_present, ot_export_present_in_manifest
- blocker: missing_critical_evidence=pcap_packet_level_modbus_evidence_present, ot_export_present_in_manifest
- blocker: missing_critical_evidence=pcap_packet_level_modbus_evidence_present, ot_export_present_in_manifest
