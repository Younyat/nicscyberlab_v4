...
- Generated at: `2026-07-29T00:25:05.400572+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.737` / `0.0`
- Alert -> memory preserved mean/std: `607.031` / `0.0`
- Alert -> case sealed mean/std: `1162.286` / `0.0`
- Total duration mean/std: `3151.62` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260728T230654Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.75` / `0.7808` / `0.8042`
- Relations recovered/degraded/ambiguous/missing: `6` / `1` / `1` / `0`
- Alert -> memory start: `14.737` seconds
- Alert -> case sealed: `1162.286` seconds
- Total repetition duration: `3151.62` seconds
