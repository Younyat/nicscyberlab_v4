...
- Generated at: `2026-07-28T19:54:18.173993+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `16.193` / `0.0`
- Alert -> memory preserved mean/std: `597.62` / `0.0`
- Alert -> case sealed mean/std: `1319.525` / `0.0`
- Total duration mean/std: `3228.787` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260728T183255Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `16.193` seconds
- Alert -> case sealed: `1319.525` seconds
- Total repetition duration: `3228.787` seconds
