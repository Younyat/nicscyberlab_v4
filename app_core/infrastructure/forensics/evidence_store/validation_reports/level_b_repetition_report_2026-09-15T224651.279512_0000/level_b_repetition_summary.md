...
- Generated at: `2026-09-15T23:47:48.710243+00:00`
...
- Compared executions: `EXEC-0001, EXEC-0002, EXEC-0003, EXEC-0004, EXEC-0005, EXEC-0006, EXEC-0007`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `17.236` / `0.0`
- Alert -> memory preserved mean/std: `600.244` / `0.0`
- Alert -> case sealed mean/std: `2587.402` / `0.0`
- Total duration mean/std: `2852.327` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260915T224654Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `17.236` seconds
- Alert -> case sealed: `2587.402` seconds
- Total repetition duration: `2852.327` seconds
