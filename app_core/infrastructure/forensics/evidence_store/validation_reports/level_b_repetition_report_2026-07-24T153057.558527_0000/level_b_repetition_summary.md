...
- Generated at: `2026-07-24T16:52:32.956155+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `28.342` / `0.0`
- Alert -> memory preserved mean/std: `797.136` / `0.0`
- Alert -> case sealed mean/std: `1427.7` / `0.0`
- Total duration mean/std: `3074.877` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260724T153111Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `28.342` seconds
- Alert -> case sealed: `1427.7` seconds
- Total repetition duration: `3074.877` seconds
