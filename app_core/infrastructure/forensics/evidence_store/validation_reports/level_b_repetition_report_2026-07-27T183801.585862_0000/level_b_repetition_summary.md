...
- Generated at: `2026-07-27T19:53:01.119442+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `13.069` / `0.0`
- Alert -> memory preserved mean/std: `726.548` / `0.0`
- Alert -> case sealed mean/std: `1268.459` / `0.0`
- Total duration mean/std: `3161.858` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260727T183815Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8755`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `13.069` seconds
- Alert -> case sealed: `1268.459` seconds
- Total repetition duration: `3161.858` seconds
