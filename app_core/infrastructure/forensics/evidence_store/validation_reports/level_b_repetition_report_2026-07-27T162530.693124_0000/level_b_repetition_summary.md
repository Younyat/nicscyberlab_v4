...
- Generated at: `2026-07-27T17:45:55.694096+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `29.725` / `0.0`
- Alert -> memory preserved mean/std: `1078.408` / `0.0`
- Alert -> case sealed mean/std: `1673.234` / `0.0`
- Total duration mean/std: `3329.381` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260727T162606Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.876`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `29.725` seconds
- Alert -> case sealed: `1673.234` seconds
- Total repetition duration: `3329.381` seconds
