...
- Generated at: `2026-09-16T02:03:15.541370+00:00`
...
- Compared executions: `EXEC-0001, EXEC-0002, EXEC-0003, EXEC-0004, EXEC-0005, EXEC-0006, EXEC-0007, EXEC-0008`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `19.512` / `0.0`
- Alert -> memory preserved mean/std: `710.721` / `0.0`
- Alert -> case sealed mean/std: `3047.173` / `0.0`
- Total duration mean/std: `3390.105` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260916T005117Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `19.512` seconds
- Alert -> case sealed: `3047.173` seconds
- Total repetition duration: `3390.105` seconds
