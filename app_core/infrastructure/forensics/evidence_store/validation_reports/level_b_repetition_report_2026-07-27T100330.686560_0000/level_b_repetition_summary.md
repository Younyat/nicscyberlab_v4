...
- Generated at: `2026-07-27T11:24:33.197054+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `31.101` / `0.0`
- Alert -> memory preserved mean/std: `836.972` / `0.0`
- Alert -> case sealed mean/std: `1433.247` / `0.0`
- Total duration mean/std: `3333.559` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260727T100347Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `31.101` seconds
- Alert -> case sealed: `1433.247` seconds
- Total repetition duration: `3333.559` seconds
