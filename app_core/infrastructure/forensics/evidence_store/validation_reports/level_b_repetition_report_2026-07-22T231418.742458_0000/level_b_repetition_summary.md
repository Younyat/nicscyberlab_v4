...
- Generated at: `2026-07-23T00:40:32.383418+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.511` / `0.0`
- Alert -> memory preserved mean/std: `582.352` / `0.0`
- Alert -> case sealed mean/std: `1834.693` / `0.0`
- Total duration mean/std: `3357.811` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260722T231431Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8722`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `14.511` seconds
- Alert -> case sealed: `1834.693` seconds
- Total repetition duration: `3357.811` seconds
