...
- Generated at: `2026-09-15T15:51:55.303868+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `17.21` / `0.0`
- Alert -> memory preserved mean/std: `661.031` / `0.0`
- Alert -> case sealed mean/std: `2336.668` / `0.0`
- Total duration mean/std: `2551.087` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260915T145324Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `17.21` seconds
- Alert -> case sealed: `2336.668` seconds
- Total repetition duration: `2551.087` seconds
