...
- Generated at: `2026-09-15T21:47:48.169443+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `16.92` / `0.0`
- Alert -> memory preserved mean/std: `597.69` / `0.0`
- Alert -> case sealed mean/std: `1519.731` / `0.0`
- Total duration mean/std: `1676.224` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260915T210911Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `16.92` seconds
- Alert -> case sealed: `1519.731` seconds
- Total repetition duration: `1676.224` seconds
