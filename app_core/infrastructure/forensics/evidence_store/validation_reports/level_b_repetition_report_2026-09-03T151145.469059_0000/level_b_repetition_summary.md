...
- Generated at: `2026-09-03T15:43:13.228576+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `15.125` / `0.0`
- Alert -> memory preserved mean/std: `846.291` / `0.0`
- Alert -> case sealed mean/std: `1383.701` / `0.0`
- Total duration mean/std: `1485.701` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260903T151148Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `15.125` seconds
- Alert -> case sealed: `1383.701` seconds
- Total repetition duration: `1485.701` seconds
