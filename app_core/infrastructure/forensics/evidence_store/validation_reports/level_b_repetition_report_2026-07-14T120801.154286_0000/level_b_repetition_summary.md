...
- Generated at: `2026-07-14T12:08:56.712769+00:00`
...
- Total duration mean/std: `17.033` / `0.0`
...
- Execution ID: `EXEC-0016`
- Case ID: `not_created`
- Status: `failed`
- Scientific case status: `diagnostic_failed`
- Attack output: `app_core/infrastructure/attack/outputs/20260714T120838Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Total repetition duration: `17.033` seconds
- Warnings: `Detection stream silent for 2 consecutive attempts. Forensic preservation was never armed because DFIR mode remained OFF during the repeated attack attempts. Alerts may have been observed, but the platform was not in forensic intervention mode.`
- Blockers: `detection_stream_silent | dfir_mode_off_during_trigger_arming`
