...
- Generated at: `2026-07-23T13:55:57.651003+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `16.251` / `0.0`
- Alert -> memory preserved mean/std: `997.627` / `0.0`
- Alert -> case sealed mean/std: `1606.904` / `0.0`
- Total duration mean/std: `3132.901` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260723T123814Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8747`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `16.251` seconds
- Alert -> case sealed: `1606.904` seconds
- Total repetition duration: `3132.901` seconds
