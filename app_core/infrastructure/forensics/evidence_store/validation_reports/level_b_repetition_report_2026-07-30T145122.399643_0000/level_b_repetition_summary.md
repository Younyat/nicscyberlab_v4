...
- Generated at: `2026-07-30T16:23:44.881734+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `13.325` / `0.0`
- Alert -> memory preserved mean/std: `565.986` / `0.0`
- Alert -> case sealed mean/std: `1687.04` / `0.0`
- Total duration mean/std: `3693.126` / `0.0`
...
- Execution ID: `EXEC-0012`
- Case ID: `case-37b2b330`
- Status: `partial`
- Scientific case status: `scientifically_complete`
- Attack output: `app_core/infrastructure/attack/outputs/20260730T145141Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8767`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `13.325` seconds
- Alert -> case sealed: `1687.04` seconds
- Total repetition duration: `3693.126` seconds
