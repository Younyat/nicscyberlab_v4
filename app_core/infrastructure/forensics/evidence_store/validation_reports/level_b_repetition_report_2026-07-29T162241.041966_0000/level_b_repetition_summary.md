...
- Generated at: `2026-07-29T17:37:44.257272+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `17.03` / `0.0`
- Alert -> memory preserved mean/std: `703.572` / `0.0`
- Alert -> case sealed mean/std: `1235.377` / `0.0`
- Total duration mean/std: `3024.842` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260729T162256Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.75` / `0.7808` / `0.8045`
- Relations recovered/degraded/ambiguous/missing: `6` / `1` / `1` / `0`
- Alert -> memory start: `17.03` seconds
- Alert -> case sealed: `1235.377` seconds
- Total repetition duration: `3024.842` seconds
