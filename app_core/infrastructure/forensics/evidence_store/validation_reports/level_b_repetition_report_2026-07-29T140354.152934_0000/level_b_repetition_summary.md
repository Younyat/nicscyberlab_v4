...
- Generated at: `2026-07-29T15:26:33.928826+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `29.523` / `0.0`
- Alert -> memory preserved mean/std: `888.257` / `0.0`
- Alert -> case sealed mean/std: `1439.304` / `0.0`
- Total duration mean/std: `3187.014` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260729T140409Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8768`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `29.523` seconds
- Alert -> case sealed: `1439.304` seconds
- Total repetition duration: `3187.014` seconds
