...
- Generated at: `2026-07-30T18:46:21.887042+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `12.56` / `0.0`
- Alert -> memory preserved mean/std: `572.452` / `0.0`
- Alert -> case sealed mean/std: `1838.82` / `0.0`
- Total duration mean/std: `3681.932` / `0.0`
...
- Execution ID: `EXEC-0013`
- Case ID: `case-78c2b34b`
- Status: `partial`
- Scientific case status: `scientifically_complete`
- Attack output: `app_core/infrastructure/attack/outputs/20260730T171621Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `12.56` seconds
- Alert -> case sealed: `1838.82` seconds
- Total repetition duration: `3681.932` seconds
