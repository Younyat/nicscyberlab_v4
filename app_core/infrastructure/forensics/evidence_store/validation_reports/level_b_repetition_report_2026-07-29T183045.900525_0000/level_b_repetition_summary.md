...
- Generated at: `2026-07-29T19:44:50.234006+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `12.252` / `0.0`
- Alert -> memory preserved mean/std: `596.141` / `0.0`
- Alert -> case sealed mean/std: `1708.256` / `0.0`
- Total duration mean/std: `3164.224` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260729T183100Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `12.252` seconds
- Alert -> case sealed: `1708.256` seconds
- Total repetition duration: `3164.224` seconds
