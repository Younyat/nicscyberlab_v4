...
- Generated at: `2026-07-22T20:12:24.759896+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `20.009` / `0.0`
- Alert -> memory preserved mean/std: `598.276` / `0.0`
- Alert -> case sealed mean/std: `1853.888` / `0.0`
- Total duration mean/std: `3177.256` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260722T185030Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
