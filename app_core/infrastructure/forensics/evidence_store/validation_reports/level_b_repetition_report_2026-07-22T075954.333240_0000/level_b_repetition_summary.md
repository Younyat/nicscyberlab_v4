...
- Generated at: `2026-07-22T09:06:55.898064+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `15.604` / `0.0`
- Alert -> memory preserved mean/std: `704.799` / `0.0`
- Alert -> case sealed mean/std: `1320.615` / `0.0`
- Total duration mean/std: `2852.811` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260722T080007Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.625` / `0.6096` / `0.7137`
- Relations recovered/degraded/ambiguous/missing: `5` / `2` / `1` / `0`
- Alert -> memory start: `15.604` seconds
- Alert -> case sealed: `1320.615` seconds
- Total repetition duration: `2852.811` seconds
