...
- Generated at: `2026-07-29T05:05:04.088452+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `15.494` / `0.0`
- Alert -> memory preserved mean/std: `647.714` / `0.0`
- Alert -> case sealed mean/std: `1890.852` / `0.0`
- Total duration mean/std: `3888.596` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260729T033255Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `15.494` seconds
- Alert -> case sealed: `1890.852` seconds
- Total repetition duration: `3888.596` seconds
