...
- Generated at: `2026-09-15T17:34:37.857940+00:00`
...
- Compared executions: `EXEC-0001, EXEC-0002, EXEC-0003, EXEC-0004`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `17.993` / `0.0`
- Alert -> memory preserved mean/std: `681.008` / `0.0`
- Alert -> case sealed mean/std: `1573.627` / `0.0`
- Total duration mean/std: `1823.981` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260915T165331Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `17.993` seconds
- Alert -> case sealed: `1573.627` seconds
- Total repetition duration: `1823.981` seconds
