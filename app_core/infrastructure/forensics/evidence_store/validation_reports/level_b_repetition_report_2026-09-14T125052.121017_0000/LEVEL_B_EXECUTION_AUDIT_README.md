...
- Forensic cases created: `case-0a3b644c`
- Cases with analysis outputs present: `case-0a3b644c`
- Nested Level A reports completed: `CMP-20260914-135953-EF7C`
- Heavy-case cleanups completed: `case-0a3b644c`
