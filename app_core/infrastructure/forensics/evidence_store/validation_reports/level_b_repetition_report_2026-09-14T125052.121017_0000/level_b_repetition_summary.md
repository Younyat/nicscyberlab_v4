...
- Generated at: `2026-09-14T14:16:56.366380+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `21.462` / `0.0`
- Alert -> memory preserved mean/std: `662.815` / `0.0`
- Alert -> case sealed mean/std: `3755.831` / `0.0`
- Total duration mean/std: `4136.66` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260914T125055Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `21.462` seconds
- Alert -> case sealed: `3755.831` seconds
- Total repetition duration: `4136.66` seconds
