...
- Generated at: `2026-07-30T07:03:25.579736+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `21.805` / `0.0`
- Alert -> memory preserved mean/std: `577.155` / `0.0`
- Alert -> case sealed mean/std: `1317.957` / `0.0`
- Total duration mean/std: `3204.219` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260730T054114Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8765`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `21.805` seconds
- Alert -> case sealed: `1317.957` seconds
- Total repetition duration: `3204.219` seconds
