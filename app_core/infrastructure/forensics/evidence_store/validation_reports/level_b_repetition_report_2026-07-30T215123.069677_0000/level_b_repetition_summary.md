...
- Generated at: `2026-07-30T23:18:14.789885+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `13.052` / `0.0`
- Alert -> memory preserved mean/std: `626.575` / `0.0`
- Alert -> case sealed mean/std: `1858.542` / `0.0`
- Total duration mean/std: `3700.938` / `0.0`
...
- Execution ID: `EXEC-0015`
- Case ID: `case-2990b1f4`
- Status: `partial`
- Scientific case status: `scientifically_complete`
- Attack output: `app_core/infrastructure/attack/outputs/20260730T215141Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8764`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `13.052` seconds
- Alert -> case sealed: `1858.542` seconds
- Total repetition duration: `3700.938` seconds
