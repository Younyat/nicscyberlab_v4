...
- Generated at: `2026-09-03T11:35:29.429635+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `13.994` / `0.0`
- Alert -> memory preserved mean/std: `571.906` / `0.0`
- Alert -> case sealed mean/std: `1716.451` / `0.0`
- Total duration mean/std: `1807.931` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260903T105641Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `13.994` seconds
- Alert -> case sealed: `1716.451` seconds
- Total repetition duration: `1807.931` seconds
