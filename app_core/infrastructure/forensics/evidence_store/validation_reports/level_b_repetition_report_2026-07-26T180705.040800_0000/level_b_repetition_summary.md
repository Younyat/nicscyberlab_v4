...
- Generated at: `2026-07-26T20:07:31.469033+00:00`
...
- Alert -> memory preserved mean/std: `623.437` / `0.0`
- Alert -> case sealed mean/std: `1851.059` / `0.0`
- Total duration mean/std: `4743.831` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260726T180720Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8745`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `14.754` seconds
- Alert -> case sealed: `1851.059` seconds
- Total repetition duration: `4743.831` seconds
