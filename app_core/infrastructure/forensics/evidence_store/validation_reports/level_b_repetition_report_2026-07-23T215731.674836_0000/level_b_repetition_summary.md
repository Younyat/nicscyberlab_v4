...
- Generated at: `2026-07-23T23:14:49.994552+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `17.155` / `0.0`
- Alert -> memory preserved mean/std: `590.553` / `0.0`
- Alert -> case sealed mean/std: `1733.496` / `0.0`
- Total duration mean/std: `2943.786` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260723T215745Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8739`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `17.155` seconds
- Alert -> case sealed: `1733.496` seconds
- Total repetition duration: `2943.786` seconds
