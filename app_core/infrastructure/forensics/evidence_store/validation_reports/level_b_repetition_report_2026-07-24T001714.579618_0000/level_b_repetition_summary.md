...
- Generated at: `2026-07-24T01:23:50.625971+00:00`
- Scenario ID: `industrial_file`
- Scenario fingerprint: `1141a59cf9fdcf006f1f6c33`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `23.389` / `0.0`
- Alert -> memory preserved mean/std: `691.844` / `0.0`
- Alert -> case sealed mean/std: `1234.225` / `0.0`
- Total duration mean/std: `2448.439` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260724T001726Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8748`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `23.389` seconds
- Alert -> case sealed: `1234.225` seconds
- Total repetition duration: `2448.439` seconds
