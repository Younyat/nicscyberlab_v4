...
- Generated at: `2026-07-26T01:31:29.292869+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `16.362` / `0.0`
- Alert -> memory preserved mean/std: `566.011` / `0.0`
- Alert -> case sealed mean/std: `1818.124` / `0.0`
- Total duration mean/std: `4820.803` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260725T232336Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8742`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `16.362` seconds
- Alert -> case sealed: `1818.124` seconds
- Total repetition duration: `4820.803` seconds
