...
- Generated at: `2026-07-24T12:18:54.885554+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.275` / `0.0`
- Alert -> memory preserved mean/std: `833.786` / `0.0`
- Alert -> case sealed mean/std: `1424.096` / `0.0`
- Total duration mean/std: `2971.831` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260724T110040Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8753`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `14.275` seconds
- Alert -> case sealed: `1424.096` seconds
- Total repetition duration: `2971.831` seconds
