...
Current decision: **Decision B: current artifacts are sufficient only for preliminary Level A/Level B audit.**
...
Obligates a fresh campaign rather than reusing current n=10 accepted Level B case(s):
...
- any final Level B denominator increase from n=10 to N_B=6
...
- `N_B_accepted = 10` accepted Level B cases
- `Industrial / OT evidence preserved = True`