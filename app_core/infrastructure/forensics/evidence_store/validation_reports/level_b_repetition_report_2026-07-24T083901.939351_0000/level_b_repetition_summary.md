...
- Generated at: `2026-07-24T10:06:44.392714+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.357` / `0.0`
- Alert -> memory preserved mean/std: `776.047` / `0.0`
- Alert -> case sealed mean/std: `2120.872` / `0.0`
- Total duration mean/std: `3493.05` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260724T083916Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8738`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `14.357` seconds
- Alert -> case sealed: `2120.872` seconds
- Total repetition duration: `3493.05` seconds
