...
- Generated at: `2026-07-29T07:26:17.580260+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.527` / `0.0`
- Alert -> memory preserved mean/std: `597.405` / `0.0`
- Alert -> case sealed mean/std: `1661.302` / `0.0`
- Total duration mean/std: `3826.627` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260729T055812Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8762`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `14.527` seconds
- Alert -> case sealed: `1661.302` seconds
- Total repetition duration: `3826.627` seconds
