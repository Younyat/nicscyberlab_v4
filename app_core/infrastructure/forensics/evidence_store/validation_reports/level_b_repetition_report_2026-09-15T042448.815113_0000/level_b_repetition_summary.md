...
- Generated at: `2026-09-15T05:35:47.537573+00:00`
...
- Compared executions: `EXEC-0001, EXEC-0002, EXEC-0003`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `19.75` / `0.0`
- Alert -> memory preserved mean/std: `639.667` / `0.0`
- Alert -> case sealed mean/std: `2989.651` / `0.0`
- Total duration mean/std: `3250.484` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260915T042451Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `19.75` seconds
- Alert -> case sealed: `2989.651` seconds
- Total repetition duration: `3250.484` seconds
