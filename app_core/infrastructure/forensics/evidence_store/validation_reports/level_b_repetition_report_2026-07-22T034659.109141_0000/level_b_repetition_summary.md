...
- Generated at: `2026-07-22T04:58:05.488857+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `45.97` / `0.0`
- Alert -> memory preserved mean/std: `626.778` / `0.0`
- Alert -> case sealed mean/std: `1860.694` / `0.0`
- Total duration mean/std: `3205.681` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260722T034711Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.625` / `0.6096` / `0.7321`
- Relations recovered/degraded/ambiguous/missing: `5` / `2` / `1` / `0`
- Alert -> memory start: `45.97` seconds
- Alert -> case sealed: `1860.694` seconds
- Total repetition duration: `3205.681` seconds
