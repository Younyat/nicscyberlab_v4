...
- Generated at: `2026-07-28T04:42:37.503991+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.91` / `0.0`
- Alert -> memory preserved mean/std: `698.123` / `0.0`
- Alert -> case sealed mean/std: `1725.613` / `0.0`
- Total duration mean/std: `3517.023` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260728T031720Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8752`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `14.91` seconds
- Alert -> case sealed: `1725.613` seconds
- Total repetition duration: `3517.023` seconds
