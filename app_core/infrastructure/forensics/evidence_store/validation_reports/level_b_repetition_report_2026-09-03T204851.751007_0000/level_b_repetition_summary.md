...
- Generated at: `2026-09-03T21:20:51.103170+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `12.614` / `0.0`
- Alert -> memory preserved mean/std: `692.622` / `0.0`
- Alert -> case sealed mean/std: `1372.71` / `0.0`
- Total duration mean/std: `1413.008` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260903T204855Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `12.614` seconds
- Alert -> case sealed: `1372.71` seconds
- Total repetition duration: `1413.008` seconds
