...
- Generated at: `2026-07-30T04:54:41.111552+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `57.393` / `0.0`
- Alert -> memory preserved mean/std: `604.786` / `0.0`
- Alert -> case sealed mean/std: `1400.973` / `0.0`
- Total duration mean/std: `3176.692` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260730T033542Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8065`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `57.393` seconds
- Alert -> case sealed: `1400.973` seconds
- Total repetition duration: `3176.692` seconds
