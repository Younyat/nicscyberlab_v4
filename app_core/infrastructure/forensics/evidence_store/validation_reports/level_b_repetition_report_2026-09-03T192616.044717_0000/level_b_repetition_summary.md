...
- Generated at: `2026-09-03T19:54:09.677517+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `13.379` / `0.0`
- Alert -> memory preserved mean/std: `744.601` / `0.0`
- Alert -> case sealed mean/std: `1263.309` / `0.0`
- Total duration mean/std: `1364.526` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260903T192618Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `13.379` seconds
- Alert -> case sealed: `1263.309` seconds
- Total repetition duration: `1364.526` seconds
