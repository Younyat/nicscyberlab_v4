...
- Generated at: `2026-07-20T03:46:46.231123+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `39.464` / `0.0`
- Alert -> memory preserved mean/std: `611.174` / `0.0`
- Alert -> case sealed mean/std: `1852.875` / `0.0`
- Total duration mean/std: `3144.608` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260720T023525Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.625` / `0.6096` / `0.7091`
- Relations recovered/degraded/ambiguous/missing: `5` / `2` / `1` / `0`
- Alert -> memory start: `39.464` seconds
- Alert -> case sealed: `1852.875` seconds
- Total repetition duration: `3144.608` seconds
