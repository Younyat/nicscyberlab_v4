...
- Generated at: `2026-09-16T04:05:04.596494+00:00`
...
- Compared executions: `EXEC-0001, EXEC-0002, EXEC-0003, EXEC-0004, EXEC-0005, EXEC-0006, EXEC-0007, EXEC-0008, EXEC-0009`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `19.394` / `0.0`
- Alert -> memory preserved mean/std: `750.595` / `0.0`
- Alert -> case sealed mean/std: `2333.96` / `0.0`
- Total duration mean/std: `2552.641` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260916T030631Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `19.394` seconds
- Alert -> case sealed: `2333.96` seconds
- Total repetition duration: `2552.641` seconds
