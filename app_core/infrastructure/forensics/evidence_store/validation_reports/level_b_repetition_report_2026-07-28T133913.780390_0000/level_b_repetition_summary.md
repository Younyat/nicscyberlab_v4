...
- Generated at: `2026-07-28T15:28:24.550116+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `15.31` / `0.0`
- Alert -> memory preserved mean/std: `632.732` / `0.0`
- Alert -> case sealed mean/std: `1604.765` / `0.0`
- Total duration mean/std: `4202.192` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260728T133932Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `15.31` seconds
- Alert -> case sealed: `1604.765` seconds
- Total repetition duration: `4202.192` seconds
