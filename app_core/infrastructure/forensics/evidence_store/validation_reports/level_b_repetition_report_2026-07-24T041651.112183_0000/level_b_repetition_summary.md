...
- Generated at: `2026-07-24T05:40:41.997125+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `13.95` / `0.0`
- Alert -> memory preserved mean/std: `598.908` / `0.0`
- Alert -> case sealed mean/std: `1946.967` / `0.0`
- Total duration mean/std: `3249.801` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260724T041704Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8735`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `13.95` seconds
- Alert -> case sealed: `1946.967` seconds
- Total repetition duration: `3249.801` seconds
