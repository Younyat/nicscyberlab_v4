...
- Generated at: `2026-07-19T23:05:31.338994+00:00`
- Scenario ID: `industrial_file`
- Scenario fingerprint: `7e310d8c8f917cc08c50a459`
...
- Alert -> memory preserved mean/std: `527.596` / `0.0`
- Alert -> case sealed mean/std: `1688.861` / `0.0`
- Total duration mean/std: `3213.395` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260719T215308Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.625` / `0.6096` / `0.7286`
- Relations recovered/degraded/ambiguous/missing: `5` / `2` / `1` / `0`
- Alert -> memory start: `64.855` seconds
- Alert -> case sealed: `1688.861` seconds
- Total repetition duration: `3213.395` seconds
