...
- Generated at: `2026-07-30T02:42:46.759254+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `13.392` / `0.0`
- Alert -> memory preserved mean/std: `598.41` / `0.0`
- Alert -> case sealed mean/std: `1762.143` / `0.0`
- Total duration mean/std: `3556.087` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260730T012015Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `13.392` seconds
- Alert -> case sealed: `1762.143` seconds
- Total repetition duration: `3556.087` seconds
