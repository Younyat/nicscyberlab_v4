...
- Generated at: `2026-09-15T11:10:54.830415+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `33.632` / `0.0`
- Alert -> memory preserved mean/std: `704.968` / `0.0`
- Alert -> case sealed mean/std: `1725.359` / `0.0`
- Total duration mean/std: `2090.707` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260915T101728Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `33.632` seconds
- Alert -> case sealed: `1725.359` seconds
- Total repetition duration: `2090.707` seconds
