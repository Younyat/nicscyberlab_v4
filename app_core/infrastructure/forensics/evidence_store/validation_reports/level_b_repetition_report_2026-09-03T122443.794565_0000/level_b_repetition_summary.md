...
- Generated at: `2026-09-03T12:54:46.380347+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.68` / `0.0`
- Alert -> memory preserved mean/std: `788.145` / `0.0`
- Alert -> case sealed mean/std: `1343.986` / `0.0`
- Total duration mean/std: `1442.523` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260903T122446Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `14.68` seconds
- Alert -> case sealed: `1343.986` seconds
- Total repetition duration: `1442.523` seconds
