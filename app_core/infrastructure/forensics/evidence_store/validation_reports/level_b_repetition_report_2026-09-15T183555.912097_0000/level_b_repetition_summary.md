...
- Generated at: `2026-09-15T20:07:26.238741+00:00`
...
- Compared executions: `EXEC-0001, EXEC-0002, EXEC-0003, EXEC-0004, EXEC-0005`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `19.737` / `0.0`
- Alert -> memory preserved mean/std: `693.995` / `0.0`
- Alert -> case sealed mean/std: `3902.563` / `0.0`
- Total duration mean/std: `4298.198` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260915T183600Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `19.737` seconds
- Alert -> case sealed: `3902.563` seconds
- Total repetition duration: `4298.198` seconds
