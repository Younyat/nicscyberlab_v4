...
- Generated at: `2026-07-29T22:27:17.016293+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `40.796` / `0.0`
- Alert -> memory preserved mean/std: `624.445` / `0.0`
- Alert -> case sealed mean/std: `1616.233` / `0.0`
- Total duration mean/std: `3610.178` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260729T205730Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `40.796` seconds
- Alert -> case sealed: `1616.233` seconds
- Total repetition duration: `3610.178` seconds
