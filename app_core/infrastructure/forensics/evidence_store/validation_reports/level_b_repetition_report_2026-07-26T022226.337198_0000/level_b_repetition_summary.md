...
- Generated at: `2026-07-26T04:04:03.367331+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.625` / `0.0`
- Alert -> memory preserved mean/std: `588.618` / `0.0`
- Alert -> case sealed mean/std: `1494.384` / `0.0`
- Total duration mean/std: `3834.985` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260726T022239Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8749`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `14.625` seconds
- Alert -> case sealed: `1494.384` seconds
- Total repetition duration: `3834.985` seconds
