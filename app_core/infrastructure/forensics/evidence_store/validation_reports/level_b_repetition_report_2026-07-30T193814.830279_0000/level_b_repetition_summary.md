...
- Generated at: `2026-07-30T20:59:11.731076+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `12.227` / `0.0`
- Alert -> memory preserved mean/std: `608.387` / `0.0`
- Alert -> case sealed mean/std: `1759.095` / `0.0`
- Total duration mean/std: `3438.971` / `0.0`
...
- Execution ID: `EXEC-0014`
- Case ID: `case-b0d41409`
- Status: `partial`
- Scientific case status: `scientifically_complete`
- Attack output: `app_core/infrastructure/attack/outputs/20260730T193830Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8763`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `12.227` seconds
- Alert -> case sealed: `1759.095` seconds
- Total repetition duration: `3438.971` seconds
