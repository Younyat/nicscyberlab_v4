...
- Generated at: `2026-07-20T10:21:07.733864+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `43.88` / `0.0`
- Alert -> memory preserved mean/std: `615.545` / `0.0`
- Alert -> case sealed mean/std: `1343.23` / `0.0`
- Total duration mean/std: `2852.595` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260720T090948Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.625` / `0.6096` / `0.7111`
- Relations recovered/degraded/ambiguous/missing: `5` / `2` / `1` / `0`
- Alert -> memory start: `43.88` seconds
- Alert -> case sealed: `1343.23` seconds
- Total repetition duration: `2852.595` seconds
