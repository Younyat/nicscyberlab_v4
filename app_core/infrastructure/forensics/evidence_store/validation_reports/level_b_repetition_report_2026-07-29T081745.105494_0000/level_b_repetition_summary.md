...
- Generated at: `2026-07-29T09:33:44.357895+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `15.532` / `0.0`
- Alert -> memory preserved mean/std: `590.541` / `0.0`
- Alert -> case sealed mean/std: `1195.929` / `0.0`
- Total duration mean/std: `2932.792` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260729T081759Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.75` / `0.7808` / `0.8043`
- Relations recovered/degraded/ambiguous/missing: `6` / `1` / `1` / `0`
- Alert -> memory start: `15.532` seconds
- Alert -> case sealed: `1195.929` seconds
- Total repetition duration: `2932.792` seconds
