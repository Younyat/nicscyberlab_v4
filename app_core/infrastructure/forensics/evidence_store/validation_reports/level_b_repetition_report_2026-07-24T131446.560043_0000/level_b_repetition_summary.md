...
- Generated at: `2026-07-24T14:38:47.059224+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.789` / `0.0`
- Alert -> memory preserved mean/std: `796.276` / `0.0`
- Alert -> case sealed mean/std: `1392.886` / `0.0`
- Total duration mean/std: `3132.837` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260724T131500Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `14.789` seconds
- Alert -> case sealed: `1392.886` seconds
- Total repetition duration: `3132.837` seconds
