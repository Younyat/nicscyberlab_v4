...
- Generated at: `2026-07-22T02:54:00.162630+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `15.497` / `0.0`
- Alert -> memory preserved mean/std: `579.925` / `0.0`
- Alert -> case sealed mean/std: `1180.596` / `0.0`
- Total duration mean/std: `2542.183` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260722T015143Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.625` / `0.6096` / `0.713`
- Relations recovered/degraded/ambiguous/missing: `5` / `2` / `1` / `0`
- Alert -> memory start: `15.497` seconds
- Alert -> case sealed: `1180.596` seconds
- Total repetition duration: `2542.183` seconds
