...
- Generated at: `2026-07-28T09:07:35.294565+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `19.369` / `0.0`
- Alert -> memory preserved mean/std: `694.728` / `0.0`
- Alert -> case sealed mean/std: `1552.22` / `0.0`
- Total duration mean/std: `3582.596` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260728T074038Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8758`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `19.369` seconds
- Alert -> case sealed: `1552.22` seconds
- Total repetition duration: `3582.596` seconds
