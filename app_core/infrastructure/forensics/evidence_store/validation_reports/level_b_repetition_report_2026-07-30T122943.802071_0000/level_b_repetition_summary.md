...
- Generated at: `2026-07-30T14:00:23.763445+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `23.627` / `0.0`
- Alert -> memory preserved mean/std: `610.24` / `0.0`
- Alert -> case sealed mean/std: `1808.728` / `0.0`
- Total duration mean/std: `3692.353` / `0.0`
...
- Execution ID: `EXEC-0011`
- Case ID: `case-1ca991f0`
- Status: `partial`
- Scientific case status: `scientifically_complete`
- Attack output: `app_core/infrastructure/attack/outputs/20260730T122959Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `23.627` seconds
- Alert -> case sealed: `1808.728` seconds
- Total repetition duration: `3692.353` seconds
