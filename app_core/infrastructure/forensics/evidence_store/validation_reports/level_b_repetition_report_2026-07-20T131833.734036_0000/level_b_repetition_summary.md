...
- Generated at: `2026-07-20T14:25:03.981582+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `47.721` / `0.0`
- Alert -> memory preserved mean/std: `703.867` / `0.0`
- Alert -> case sealed mean/std: `1272.218` / `0.0`
- Total duration mean/std: `2763.252` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260720T131845Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.625` / `0.6096` / `0.7305`
- Relations recovered/degraded/ambiguous/missing: `5` / `2` / `1` / `0`
- Alert -> memory start: `47.721` seconds
- Alert -> case sealed: `1272.218` seconds
- Total repetition duration: `2763.252` seconds
