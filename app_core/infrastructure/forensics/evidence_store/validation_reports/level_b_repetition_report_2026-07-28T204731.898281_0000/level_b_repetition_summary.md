...
- Generated at: `2026-07-28T22:12:49.768035+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.484` / `0.0`
- Alert -> memory preserved mean/std: `569.419` / `0.0`
- Alert -> case sealed mean/std: `1545.285` / `0.0`
- Total duration mean/std: `3525.541` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260728T204746Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `14.484` seconds
- Alert -> case sealed: `1545.285` seconds
- Total repetition duration: `3525.541` seconds
