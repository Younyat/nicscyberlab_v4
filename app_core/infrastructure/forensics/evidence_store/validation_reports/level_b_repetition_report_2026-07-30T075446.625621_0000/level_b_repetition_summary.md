...
- Generated at: `2026-07-30T09:19:40.410913+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.994` / `0.0`
- Alert -> memory preserved mean/std: `577.711` / `0.0`
- Alert -> case sealed mean/std: `1267.792` / `0.0`
- Total duration mean/std: `3535.432` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260730T075506Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8766`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `14.994` seconds
- Alert -> case sealed: `1267.792` seconds
- Total repetition duration: `3535.432` seconds
