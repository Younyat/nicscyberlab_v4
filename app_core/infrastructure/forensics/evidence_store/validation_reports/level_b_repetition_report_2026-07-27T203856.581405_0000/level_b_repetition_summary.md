...
- Generated at: `2026-07-27T22:02:28.976936+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `13.673` / `0.0`
- Alert -> memory preserved mean/std: `575.934` / `0.0`
- Alert -> case sealed mean/std: `1746.558` / `0.0`
- Total duration mean/std: `3531.716` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260727T203914Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `13.673` seconds
- Alert -> case sealed: `1746.558` seconds
- Total repetition duration: `3531.716` seconds
