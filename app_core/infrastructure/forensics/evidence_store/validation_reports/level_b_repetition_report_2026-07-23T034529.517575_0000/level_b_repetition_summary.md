...
- Generated at: `2026-07-23T05:13:06.089882+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.754` / `0.0`
- Alert -> memory preserved mean/std: `603.098` / `0.0`
- Alert -> case sealed mean/std: `1847.001` / `0.0`
- Total duration mean/std: `3420.612` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260723T034544Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8725`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `14.754` seconds
- Alert -> case sealed: `1847.001` seconds
- Total repetition duration: `3420.612` seconds
