...
- Generated at: `2026-09-15T03:23:52.842744+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `18.972` / `0.0`
- Alert -> memory preserved mean/std: `956.281` / `0.0`
- Alert -> case sealed mean/std: `2038.373` / `0.0`
- Total duration mean/std: `2259.888` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260915T023145Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `18.972` seconds
- Alert -> case sealed: `2038.373` seconds
- Total repetition duration: `2259.888` seconds
