...
- Generated at: `2026-07-22T22:23:52.086557+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.355` / `0.0`
- Alert -> memory preserved mean/std: `547.416` / `0.0`
- Alert -> case sealed mean/std: `1573.482` / `0.0`
- Total duration mean/std: `3213.957` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260722T210404Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8729`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `14.355` seconds
- Alert -> case sealed: `1573.482` seconds
- Total repetition duration: `3213.957` seconds
