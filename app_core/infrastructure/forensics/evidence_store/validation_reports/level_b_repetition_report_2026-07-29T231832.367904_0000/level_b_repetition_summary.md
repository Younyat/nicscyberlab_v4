...
- Generated at: `2026-07-30T00:29:03.452505+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `13.866` / `0.0`
- Alert -> memory preserved mean/std: `577.479` / `0.0`
- Alert -> case sealed mean/std: `1167.92` / `0.0`
- Total duration mean/std: `2795.926` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260729T231848Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.75` / `0.7808` / `0.8046`
- Relations recovered/degraded/ambiguous/missing: `6` / `1` / `1` / `0`
- Alert -> memory start: `13.866` seconds
- Alert -> case sealed: `1167.92` seconds
- Total repetition duration: `2795.926` seconds
