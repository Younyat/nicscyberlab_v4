...
- Generated at: `2026-09-14T11:49:56.790003+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `44.219` / `0.0`
- Alert -> memory preserved mean/std: `669.455` / `0.0`
- Alert -> case sealed mean/std: `1647.353` / `0.0`
- Total duration mean/std: `1944.69` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260914T110531Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `44.219` seconds
- Alert -> case sealed: `1647.353` seconds
- Total repetition duration: `1944.69` seconds
