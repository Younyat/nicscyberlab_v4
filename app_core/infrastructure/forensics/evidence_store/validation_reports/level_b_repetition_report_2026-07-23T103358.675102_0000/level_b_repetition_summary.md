...
- Generated at: `2026-07-23T11:44:17.149439+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `28.846` / `0.0`
- Alert -> memory preserved mean/std: `678.34` / `0.0`
- Alert -> case sealed mean/std: `1317.647` / `0.0`
- Total duration mean/std: `2694.907` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260723T103411Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8737`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `28.846` seconds
- Alert -> case sealed: `1317.647` seconds
- Total repetition duration: `2694.907` seconds
