...
- Generated at: `2026-09-15T01:29:43.289269+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `35.639` / `0.0`
- Alert -> memory preserved mean/std: `698.194` / `0.0`
- Alert -> case sealed mean/std: `3512.497` / `0.0`
- Total duration mean/std: `3860.983` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260915T000929Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Alert -> memory start: `35.639` seconds
- Alert -> case sealed: `3512.497` seconds
- Total repetition duration: `3860.983` seconds
