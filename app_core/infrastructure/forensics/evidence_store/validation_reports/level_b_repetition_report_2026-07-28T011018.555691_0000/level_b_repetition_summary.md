...
- Generated at: `2026-07-28T02:22:51.728598+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `14.416` / `0.0`
- Alert -> memory preserved mean/std: `690.656` / `0.0`
- Alert -> case sealed mean/std: `1271.609` / `0.0`
- Total duration mean/std: `2952.703` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260728T011035Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8757`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `14.416` seconds
- Alert -> case sealed: `1271.609` seconds
- Total repetition duration: `2952.703` seconds
