...
- Generated at: `2026-07-20T12:25:48.711452+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `34.799` / `0.0`
- Alert -> memory preserved mean/std: `624.933` / `0.0`
- Alert -> case sealed mean/std: `1814.475` / `0.0`
- Total duration mean/std: `3098.541` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260720T111320Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.625` / `0.6096` / `0.6414`
- Relations recovered/degraded/ambiguous/missing: `5` / `2` / `1` / `0`
- Alert -> memory start: `34.799` seconds
- Alert -> case sealed: `1814.475` seconds
- Total repetition duration: `3098.541` seconds
