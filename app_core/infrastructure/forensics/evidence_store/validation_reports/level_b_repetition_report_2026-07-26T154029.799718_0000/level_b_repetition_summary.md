...
- Generated at: `2026-07-26T17:14:19.132495+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `20.615` / `0.0`
- Alert -> memory preserved mean/std: `641.203` / `0.0`
- Alert -> case sealed mean/std: `1862.392` / `0.0`
- Total duration mean/std: `3896.046` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260726T154045Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8744`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `20.615` seconds
- Alert -> case sealed: `1862.392` seconds
- Total repetition duration: `3896.046` seconds
