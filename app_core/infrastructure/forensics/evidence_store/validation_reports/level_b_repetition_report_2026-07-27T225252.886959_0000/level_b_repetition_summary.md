...
- Generated at: `2026-07-28T00:15:35.791833+00:00`
...
- `N_B`: `1`
- Alert -> memory start mean/std: `13.982` / `0.0`
- Alert -> memory preserved mean/std: `568.844` / `0.0`
- Alert -> case sealed mean/std: `1721.466` / `0.0`
- Total duration mean/std: `3485.341` / `0.0`
...
- Attack output: `app_core/infrastructure/attack/outputs/20260727T225307Z_T0831_MANIPULATION_OF_CONTROL_MODBUS`
...
- Recoverability / weighted / confidence: `0.875` / `0.8767` / `0.8756`
- Relations recovered/degraded/ambiguous/missing: `7` / `0` / `1` / `0`
- Alert -> memory start: `13.982` seconds
- Alert -> case sealed: `1721.466` seconds
- Total repetition duration: `3485.341` seconds
